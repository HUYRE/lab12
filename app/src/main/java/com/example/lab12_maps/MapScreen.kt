        ...
        Column {
            ...
            GoogleMap(
                ...
                Marker(
                    ...
                    icon = bitmapFromVector(context, R.drawable.icon_anais),
                    title = "Arequipa, Perú"
                )
                ...
                // Recorrido
                val bikeTrailExtended = listOf(
                    LatLng(-16.430999, -71.537649), // Inicio
                    LatLng(-16.431130, -71.541150), // Intermedio
                    LatLng(-16.432120, -71.543500), // Fin del primer segmento
                    LatLng(-16.433000, -71.546000), // Punto de llegada

                    // Extensión de la ruta
                    LatLng(-16.433750, -71.548400), // Cerca al Parque Lambramani
                    LatLng(-16.434900, -71.550900), // Av. Lambramani
                    LatLng(-16.436100, -71.553300), // Cerca al Mall Aventura Plaza
                    LatLng(-16.437450, -71.555800), // Zona residencial Umacollo
                    LatLng(-16.438600, -71.558200), // Zona de la Universidad Nacional de San Agustín
                    LatLng(-16.439900, -71.560400), // Cerca al Puente Chilina
                    LatLng(-16.441300, -71.562600), // Mirador de Yanahuara
                    LatLng(-16.442500, -71.564800), // Punto final (cerca a un área de descanso)
                )


                Polyline(
                    points = bikeTrailExtended,
                    color = Color.Red,
                    width = 8f
                )
            }
